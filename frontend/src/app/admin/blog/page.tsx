  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2 rounded-2xl border border-slate-100 bg-white p-3">
        <input value={search} onChange={(event) => { setSearch(event.target.value); setPage(1); }} placeholder="جستجوی نوشته..." className="min-w-48 flex-1 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs outline-none focus:border-brand-400" />
