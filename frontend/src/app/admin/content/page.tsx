      ...
      <div className="grid items-start gap-5 lg:grid-cols-[16rem_minmax(0,1fr)]">
        ...
        <main className="min-w-0">
          {pageLoading ? (
            ...
            <div className="grid min-h-[28rem] place-items-center rounded-2xl border border-red-100 bg-white p-8 text-center">
              <div>
            ...
            <div className="grid min-h-[28rem] place-items-center rounded-2xl border border-slate-100 bg-white p-8 text-center text-sm text-slate-400">
