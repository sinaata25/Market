...
/** نشان درصد تخفیف — قرمز و فشرده، کنار قیمت نهایی */
 ...
 *
 * چیدمان (راست‌به‌چپ): سطر اول «نشان تخفیف + قیمت نهایی»، سطر دوم قیمت قبلی
 * با خط‌خوردگی. ارتفاع سطر دوم همیشه رزرو می‌شود تا قیمتِ کارت‌های یک ردیف —
 * تخفیف‌دار یا بدون تخفیف — روی یک خط بنشیند.
 */
